...
public class Booking {
	...
	@jakarta.persistence.OneToOne(mappedBy = "booking", cascade = jakarta.persistence.CascadeType.ALL, fetch = jakarta.persistence.FetchType.LAZY)
	@com.fasterxml.jackson.annotation.JsonManagedReference(value = "booking-payment")
