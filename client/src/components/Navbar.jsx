...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-40 backdrop-blur-xl bg-slate-950/80 border-b border-slate-800/80 transition-all duration-300">
            ...
            {user ? (
              <div className="flex items-center gap-3 pl-3 border-l border-slate-800">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-semibold shadow-inner border border-white/10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="inline-flex items-center gap-1 text-[11px] font-medium text-indigo-400">
                      ...
                      {user.role === 'CarOwner' ? 'Car Owner' : 'Customer'}
                    </span>
                  </div>
                </div>
